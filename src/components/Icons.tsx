...
export const LinkedIn = memo<IconProps>(({ className = "" }) => (
    <svg className={ className } fill="currentColor" viewBox="0 0 24 24" { ...svgProps }>
        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
    </svg>
))

export const GitHub = memo<IconProps>(({ className = "" }) => (
    <svg className={ className } fill="currentColor" viewBox="0 0 24 24" { ...svgProps }>
...
export const Trailhead = memo<IconProps>(({ className = "" }) => (
    <svg className={ className } fill="currentColor" viewBox="0 0 52 52" { ...svgProps }>
        <g>
...
const StrokeIcon = memo<IconProps & { children: React.ReactNode }>(({ className = "", children }) => (
    <svg className={ className } fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" { ...svgProps }>
        { children }
    </svg>
))

export const Globe = memo<IconProps>(({ className }) => (
...
export const X = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Menu = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Sun = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Moon = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
    </StrokeIcon>
))

export const Clipboard = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Lightbulb = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Zap = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
        <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
    </StrokeIcon>
))

export const Check = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
        <polyline points="20 6 9 17 4 12" />
    </StrokeIcon>
))

export const ArrowRight = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Layers = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const GitBranch = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Compass = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
        <circle cx="12" cy="12" r="10" />
...
export const Mail = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const CheckCircle = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Bolt = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Cv = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Calendar = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Brain = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Database = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
...
export const Users = memo<IconProps>(({ className }) => (
    <StrokeIcon className={ className }>
